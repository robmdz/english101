...
const Card = ({ title, subtitle, rating, backgroundColors, className="", image }: { title: string | undefined, subtitle: string | undefined, rating: string | undefined, backgroundColors: { top: string, bottom: string }, className: string, image: string }) => {
